...
2026 전남광주 청년 AI 솔버톤 · B트랙 · 팀 코스모스 · 「비즈버디(BizBuddy)」

이 폴더는 비즈버디가 실제로 운영 중인 클라우드 DB의 **스키마·구조·적재 데이터**를 심사에서 바로 확인하실 수 있게 정리한 것입니다.
...
- 전체 구현 명세: [`비즈버디_PRD.md`](../../비즈버디_PRD.md) — §5.5에 스키마 설계 근거, §7에 AI 파이프라인 명세
