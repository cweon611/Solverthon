      ...
      <Card radius="3xl" clip className="w-full max-w-md">
        ...
        <form onSubmit={submit} className="px-7 py-6 space-y-3">
          ...
          <div>
            ...
            <Input id="loginId" variant="authLg" autoComplete="username" placeholder="영문 소문자·숫자·_ . - 4~20자"
          ...
          <div>
            ...
            <Input id="password" type="password" variant="authLg" autoComplete="new-password" placeholder="8자 이상"
              value={password} onChange={(e) => setPassword(e.target.value)} disabled={busy} required />
          </div>
          <div>
            <Label variant="field" htmlFor="password2">비밀번호 확인</Label>
            <Input id="password2" type="password" variant="authLg" autoComplete="new-password"
          ...
          {error && <Alert><p className="text-rose-700 text-xs">{error}</p></Alert>}
